...
### Тестирование
В файле Main.java тестируется программа. Создается список дел. В него добавляется 6 разных дел и седьмое, такое же, как первое. Далее список выводится.Добавилось и вывелось только 6 разных дел.
